  ...
  return (
    <React.Fragment>
      ...
      <Container className="payment">
        ...
        <VisibleOnSmall>
          <TopSmallVisibility>
            Designed for companies with trade payment settlement and
            international remittance challenges
          </TopSmallVisibility>
        </VisibleOnSmall>
        <StyledWrapper>
          <LeftWrapper>
            ...
            <SmallPaymentFunction>
              <div className="row align-items">
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                  ...
                  <FunctionHeader>Quick</FunctionHeader>
                  <FunctionText>
                    Confirmation of deposit within one hour
                  </FunctionText>
                </div>
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                  <FunctionIcon data-aos="flip-right">
                  ...
                  <FunctionHeader>Secure</FunctionHeader>

                  <FunctionText>
                    Safe remittance through escrow service
                  </FunctionText>
                </div>
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                  ...
                  <FunctionHeader>Low rates</FunctionHeader>

                  <FunctionText>Commissions from 0.7%~</FunctionText>
                </div>
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                  <FunctionIcon data-aos="flip-right">
                    <img src={TenMin} alt="Digitrad Fast Payment" />
                  </FunctionIcon>
                  <FunctionHeader>Easy</FunctionHeader>
                  <FunctionText>
                    Sign-up Guided inquiry submission in under 10 minutes
                  </FunctionText>
                </div>
              </div>
            </SmallPaymentFunction>
