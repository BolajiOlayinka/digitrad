      ...
      <Container>
        <HeaderSection className="crossborder">
          <div>
            ...
            <SubHeading>An all inclusive platform</SubHeading>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-xl-4 col-lg-4 col-md-4 col-12">
              <Section>
                ...
                <IconText>Global market entry support</IconText>
              </Section>
            </div>
            <div className="col-xl-4 col-lg-4 col-md-4 col-12">
              <Section>
                ...
                <IconText>Door to door shipping solutions</IconText>
              </Section>
            </div>
            <div className="col-xl-4 col-lg-4 col-md-4 col-12">
              <Section>
                ...
                <IconText>Quick and easy product listing</IconText>
              </Section>
            </div>
          </div>
        </IconsWrapper>
        ...
        <TickSection>
          <div>
            ...
            <TickText>Simple setup</TickText>
          </div>
          <div>
            <TickIcon data-aos="fade-up" style={{ transitionDuration: "1.2s" }}>
              <img src={Tick} alt="digitrad Icon" />
            </TickIcon>
            <TickText>Security services</TickText>
          </div>
