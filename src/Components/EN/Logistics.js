    ...
    <div style={{ position: "relative" }}>
      ...
      <Container className="logistics">
        <HeaderSection>
          ...
          <div>
            <Heading>Overseas Logistics</Heading>
            <SmallHeading>Overseas Logistics</SmallHeading>
            <SubHeading>
            Exporting product can be a frustrating experience. DiGiTRAD can halve the work, and increase profit and productivity,
            </SubHeading>
          </div>
        </HeaderSection>
        <SmallHeaderSection>
        ...
        <CircleTickSection>
          <FunctionBody data-aos="fade-right">
            ...
            <TickText>Confirmation of import and export regulation details</TickText>
          </FunctionBody>

          <FunctionBody data-aos="fade-right">
            <img src={TickCircle} alt="tickcircle" />
            <TickText>Auto-generation of export documentation</TickText>
          </FunctionBody>
          ...
          >
            <img src={TickCircle} alt="tickcircle" />
            <TickText>Chat based communication with logistic company (English support available) </TickText>
          </FunctionBody>
        </CircleTickSection>
        <SmallCircleTick>
          <SmallBackgroundLine
          ...
          <TickSection>
            <Section>
              ...
              />
              <SectionText>Confirmation of import and export regulation details</SectionText>
            </Section>
            <Section>
              <img
                src={TickCircle}
              ...
              />
              <SectionText>Auto-generation of export documentation</SectionText>
            </Section>
            <Section>
              <img
                src={TickCircle}
                ...
                style={{ transitionDuration: "2.4s" }}
              />
              <SectionText>Chat based communication with logistic company (English support available) </SectionText>
            </Section>
          </TickSection>
        </SmallCircleTick>
        <Center>
          <PriceConfidant disabled="true">
          Match for lowest price
          </PriceConfidant>
          ...
          Confirmation of final dimensions for immediate estimate generation
          </SizeContainer>
        </Center>
        <CenterButton>
          <ActionButton
